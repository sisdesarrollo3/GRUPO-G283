...
def graficar_pastel( data ):
    ...
    #AXS lista de Ejes (1 fila y 2 columnas), fig objeto de la figura completa
    fig, axs = plt.subplots(1, 2, figsize=(8, 5), facecolor='white')
    fig.suptitle('ENERGIAS RENOVALBLES - COMPARATIVO', fontsize=14, fontweight='bold')
    ...
    axs[0].set_title("PRODUCCIÓN POR PAIS")
    #plt.tight_layout()
    #plt.show()
    ...
    axs[1].set_title("CONSUMO POR PAIS")
    plt.tight_layout()
    plt.show()
